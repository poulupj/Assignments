...
TEST(NoDeletionTest, SizeUnderLimit)
{
    ...
    expectedDirectoryEntries.push_back(std::filesystem::directory_entry("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/f1.txt"));
    expectedDirectoryEntries.push_back(std::filesystem::directory_entry("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/dir1/f2.txt"));
    expectedDirectoryEntries.push_back(std::filesystem::directory_entry("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/dir1/f3.txt"));
    expectedDirectoryEntries.push_back(std::filesystem::directory_entry("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/dir2/f4.txt"));
    expectedDirectoryEntries.push_back(std::filesystem::directory_entry("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/dir2/f5.txt"));
...
TEST(DeletionTest, FolderRemoved)
{
    ...
    ASSERT_FALSE(std::filesystem::exists("/home/poulu/Desktop/Github/Assignments/fs_limit_dir/sample_dir/dir1/"));
